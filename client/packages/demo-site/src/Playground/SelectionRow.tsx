    ...
    return (
        <>
            <tr>
                ...
                <td>
                    <Select options={aggregationsForDataType[getColumnDataType(table, column)]} value={aggregation} onChange={setAggregation} />
                </td>
                <td>
            ...
            {expanded && aggregation && (
                <>
                    ...
                    {filters.map((_, index) => (
                        <FilterRow key={index} filters={filters} setFilters={setFilters} index={index} nested={true} />
                    ))}
                    <tr className="spacer">
                        <td colSpan={5} />
                    </tr>
