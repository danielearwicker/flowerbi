namespace FlowerBI.Engine.Tests
{
    ...
    public static class TestSchema
    {
        ...
        {
            public static readonly PrimaryKey<long> Id = new PrimaryKey<long>("Id");
            public static readonly ForeignKey<long> VendorId = new ForeignKey<long>("VendorId", Vendor.Id, x => x * 2);
            public static readonly ForeignKey<long> DepartmentId = new ForeignKey<long>("DepartmentId", Department.Id, x => x * 2);
