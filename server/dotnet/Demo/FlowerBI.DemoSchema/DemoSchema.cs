...
public static class BugSchema
{
    ...
    public static class Date
    {
        ...
        public static readonly Column<short> CalendarYearNumber = new Column<short>(
            "CalendarYearNumber"
        );
        public static readonly Column<DateTime> FirstDayOfQuarter = new Column<DateTime>(
            "FirstDayOfQuarter"
        );
        public static readonly Column<DateTime> FirstDayOfMonth = new Column<DateTime>(
            "FirstDayOfMonth"
        );
    }
    ...
    {
        public static readonly PrimaryKey<DateTime> Id = new PrimaryKey<DateTime>(
            "Id",
            extends: Date.Id
        );
        public static readonly Column<short> CalendarYearNumber = new Column<short>(
            "CalendarYearNumber",
            extends: Date.CalendarYearNumber
        );
        public static readonly Column<DateTime> FirstDayOfQuarter = new Column<DateTime>(
            "FirstDayOfQuarter",
            extends: Date.FirstDayOfQuarter
        );
        public static readonly Column<DateTime> FirstDayOfMonth = new Column<DateTime>(
            "FirstDayOfMonth",
            extends: Date.FirstDayOfMonth
        );
    }
    ...
    public static class CoderAssigned
    {
        ...
        public static readonly Column<string> FullName = new Column<string>(
            "FullName",
            extends: Coder.FullName
        );
    }
    ...
    {
        public static readonly PrimaryKey<int> Id = new PrimaryKey<int>("Id");
        public static readonly ForeignKey<int> WorkflowId = new ForeignKey<int>(
            "WorkflowId",
            Workflow.Id
        );
        public static readonly ForeignKey<int> CustomerId = new ForeignKey<int>(
            "CustomerId",
            Customer.Id
        );
        public static readonly ForeignKey<DateTime> ReportedDate = new ForeignKey<DateTime>(
            "ReportedDate",
            DateReported.Id
        );
        public static readonly ForeignKey<DateTime> ResolvedDate = new ForeignKey<DateTime>(
            "ResolvedDate",
            DateResolved.Id
        );
        public static readonly ForeignKey<DateTime> AssignedDate = new ForeignKey<DateTime>(
            "AssignedDate",
            DateAssigned.Id
        );
        public static readonly ForeignKey<int> CategoryCombinationId = new ForeignKey<int>(
            "CategoryCombinationId",
            CategoryCombination.Id
        );
        public static readonly ForeignKey<int> AssignedCoderId = new ForeignKey<int>(
            "AssignedCoderId",
            CoderAssigned.Id
        );
        public static readonly ForeignKey<int> ResolvedCoderId = new ForeignKey<int>(
            "ResolvedCoderId",
            CoderResolved.Id
        );
    }
